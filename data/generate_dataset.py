...
TEMPLATES = {
    "NAVIGATION": {
        "templates": [
            ...
            "stop moving", "stop right there", "halt right there", "freeze right now", "don't move",
    ...
    "STORY": {
        "templates": [
            ...
            "begin a tale about {char}", "tell me an adventure story about {char}",
            ...
            "spin me a yarn about {char}", "i wanna hear a story about {char}",
            "tell a {genre} story please",
            "continue the story", "what happens next in the story",
            "and then what happened in the story",
            "keep going with the story", "go on with the story",
            "continue the story please",
            "tell me more of the story", "don't stop the story",
            "what's the next part of the story",
            "what happened after that in the story",
            "i want to hear more of the story",
            "keep telling the story", "more of the story please",
            ...
            "in the story does {char} win", "in the story will {char} be okay",
            "in the story is {char} safe", "in the story what does {char} find",
            "where does {char} go next in the story",
            "in the story who does {char} meet", "how does the story end",
            "is there a happy ending", "in the story what happens to {char}",
            ...
            "in the story what if {char} meets {char2}",
    ...
    "GAME": {
        "templates": [
            ...
            "in the game the answer is {ans}", "in the game i think it's {ans}",
            "my game answer is {ans}", "for the game i choose {ans}",
            "i pick {ans} for the game", "in the game i'll go with {ans}",
            "i'll guess {ans}", "my guess is {ans}",
            "for this round i pick {ans}", "let me guess {ans}",
            "{ans} is my final game answer", "i'm guessing {ans}",
            "for the game i'll say {ans}", "final answer {ans}",
            "in the game it must be {ans}",
        ...
        "slots": {
            ...
            "ans": [
                ...
                "the cat", "the dog", "blue", "red",
                "left", "right", "five", "ten", "twenty",
            ],
        },
    },
    "SYSTEM": {
        "templates": [
            ...
            "stop everything", "cancel all tasks", "abort",
